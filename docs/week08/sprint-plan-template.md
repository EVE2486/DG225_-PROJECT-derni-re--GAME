...
**Sprint Goal:** [ทำตัว Prototype ให้เล่นได้]
...
### Story 4 — [As a player, I want to see character move and attack smoothly, realistiic]
...
**เมื่อวาน:** ส่งเฟรมรูปภาพ อินโทรก่อนเริ่มเกมให้ designer ดู
**วันนี้:** วางโครงร่างฉากพื้นหลัง แก้ดีเทลไอเท็มต่าง ๆ ให้เข้ากับธีมของเกม
**Blocked:** ไม่เอาดีไซน์เดิมของตัวละครหลัก
