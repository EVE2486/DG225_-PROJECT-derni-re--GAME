...
---
# 48-Hour Timeline — [แกงเขียวหวานไก่ จำกัด]

| หัวข้อ                             | รายละเอียด         |
| ---------------------------------------- | ---------------------------- |
| Time Keeper                              | [682110109]                  |
| Jam เริ่มจริง (วัน-เวลา) | [ศ. 24 ก.ค. 2569 16:00]   |
| Deadline ส่งงาน (วัน-เวลา)  | [อา. 26 ก.ค. 2569 16:00] |
...
| ------------------------------------------- | --------------- | -------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ---------- | -------------------------------- |
| 0. Kickoff & Ideation                       | 0–2            | [เวลา] – [เวลา]                           | รู้ theme, brainstorm, + core loop 1 บรรทัด                                             | 🔲         |                                  |
| 1. Planning & Setup                         | 2–4            | [เวลา] – [เวลา]                           | GDD one-pager, ตกลง pipeline, ตั้ง repo, แบ่งงาน                                  | 🔲         |                                  |
| 2. Core Pipeline & Skeleton                 | 4–10           | [เวลา] – [เวลา]                           | Game loop โครงหลักรันได้ (state, input, render ว่างเปล่า)                 | 🔲         |                                  |
| 3. Core Mechanic                            | 10–20          | [เวลา] – [เวลา]                           | กลไกหลักเล่นได้จริง 1 อย่าง —**Playable Build Checkpoint**        | 🔲         |                                  |
| 4. Content & Feature Build-out              | 20–30          | [เวลา] – [เวลา]                           | ด่าน/เนื้อหา, UI/HUD, เสียง, กลไกรอง                                      | 🔲         |                                  |
| 5. 🔒 Feature Freeze                        | ที่ Hour 30  | [เวลา]                                         | **ห้ามเพิ่ม feature ใหม่หลังจุดนี้** ทุกคน merge เข้า main | 🔲         |                                  |
| 6. Polish & Bugfix                          | 30–40          | [เวลา] – [เวลา]                           | แก้บั๊ก, ปรับ balance, juice/feedback เล็กๆ                                      | 🔲         |                                  |
