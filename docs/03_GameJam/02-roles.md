...
---
# Team Roles & Pipeline Ownership — [แกงเขียวหวานไก่ จำกัด]

## แบ่งความรับผิดชอบตาม Pipeline (4 คน)

| คน | ชื่อ    | Module ที่รับผิดชอบ         | Phase ที่ต้องเสร็จ |
| ---- | ----------- | --------------------------------------- | ------------------------------ |
| 1    | [682110151] | `GameStateManager` + `InputManager` | Phase 2 (Hour 6–14)           |
| 2    | [682110109] | Core mechanic `Update()` logic        | Phase 2–3 (Hour 6–24)        |
| 3    | [682110155] | Render/`SpriteBatch` + Collision      | Phase 2–3 (Hour 6–24)        |
| 4    | [682110135] | Content pipeline (MGCB) + Audio/UI      | Phase 3–4 (Hour 14–34)       |
...
| -------------------------------------------------------- | ---------------------- | -------------------------------------------------------------------- |
| `Game1.cs`                                             | [682110151]            | [ให้แจ้งใน chat ก่อนแก้ แล้ว pull ก่อน push] |
| [คาดว่าอาจจะมีแต่ ณ ตอนนี้ยัง] | [-]                    | [-]                                                                  |
